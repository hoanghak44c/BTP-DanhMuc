...
{
    public class frmLookUp_Model :frmLookUpBaseSegmentInfo
    {
        private GridColumn colMa;
        private GridColumn colTen;

        public frmLookUp_Model()
        {
            InitializeComponent();
        }

        public frmLookUp_Model(string searchInput)
            : base(searchInput)
        {
            InitializeComponent();
        }

        public frmLookUp_Model(bool isMultiSelect)
            : base(isMultiSelect)
        {
            InitializeComponent();
        }

        public frmLookUp_Model(bool isMultiSelect, string searchInput)
        ...
        {
            ListInitInfo =
                DmModelDataProvider.Instance.GetListSegmentChildInfor().ConvertAll(
        ...
        private void InitializeComponent()
        {
            ...
            this.Name = "frmLookUp_Model";
            this.Text = "Tìm kiếm nhanh Model";
