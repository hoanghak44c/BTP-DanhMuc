...
{
    public class frmLookUp_KhoDieuChuyen : frmLookUpBaseKhoDieuChuyen
    {
        private GridColumn colMaKho;
        private GridColumn colTenKho;

        public frmLookUp_KhoDieuChuyen(int idNhanVien)
            : base(idNhanVien)
        {
            InitializeComponent();
        }

        public frmLookUp_KhoDieuChuyen(int idNhanVien, bool isMultiSelect)
        ...
        private void InitializeComponent()
        {
            ...
            this.Name = "frmLookUp_KhoDieuChuyen";
