...
{
    public class ChiTietSegmentChildNganhController : ChiTietDmSegmentChildBaseController<SegmentChildInfo>
    {
        public ChiTietSegmentChildNganhController()
        {
            Provider = DmNganhDataProvider.Instance;
        }
