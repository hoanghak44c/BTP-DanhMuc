...
{
    public class ChiTietSegmentChildNhomController : ChiTietDmSegmentChildBaseController<SegmentChildInfo>
    {
        public ChiTietSegmentChildNhomController()
        {
            Provider = DmNhomDataProvider.Instance;
        }
