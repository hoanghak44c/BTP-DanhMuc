...
{
    public class frmLookUp_Chung :frmLookUpBaseSegmentInfo
    {
        private GridColumn colMa;
        private GridColumn colTen;

        public frmLookUp_Chung()
        {
            InitializeComponent();
        }

        public frmLookUp_Chung(string searchInput)
            : base(searchInput)
        {
            InitializeComponent();
        }

        public frmLookUp_Chung(bool isMultiSelect)
            : base(isMultiSelect)
        {
            InitializeComponent();
        }

        public frmLookUp_Chung(bool isMultiSelect, string searchInput)
        ...
        {
            ListInitInfo =
                DmChungDataProvider.Instance.GetListSegmentChildInfor().ConvertAll(
        ...
        private void InitializeComponent()
        {
            ...
            this.Name = "frmLookUp_Chung";
            this.Text = "Tìm kiếm nhanh Chủng";
