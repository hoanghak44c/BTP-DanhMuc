...
{
    public class DmModelDataProvider : DmSegmentChildDataProvider, IDanhMucEditInfor<SegmentChildInfo>
    {
        private static DmModelDataProvider instance;

        public static DmModelDataProvider Instance
        {
            get
            {
                if (instance == null) instance = new DmModelDataProvider();
                return instance;
            }
        }
        ...
        {
            return DmModelDAO.Instance.GetListSegmentInfor();
        }

        public SegmentChildInfo GetFullInfoByKey(params object[] keyParams)
        {
            return DmModelDAO.Instance.GetListSegmentInfor().Find(delegate(SegmentChildInfo match)
